...
int main() {
    ...
    while (1) {
        ...
        switch (choice) {
            ...
            case 3: saveEvents(events, numEvents); return 0;
...
void addEvent(Event events[], int *numEvents) {
    ...
    if (scanf("%d-%d-%d", &newEvent.date_time.tm_year, &newEvent.date_time.tm_mon, &newEvent.date_time.tm_mday) != 3) {
    ...
    if (scanf("%d:%d", &newEvent.date_time.tm_hour, &newEvent.date_time.tm_min) != 2) {
